...
<template>
    <div v-show="hide" class="choice">
        ...
        <div class="but">
            <div class="seek">
                <img alt="" class="icon" src="../../../src/assets/icon/ss.png" />
                搜索
            </div>
            <div class="empty" @click="sweepaway()">
                <img alt="" class="icon1" src="../../../src/assets/icon/sc.png" />
                清空
            </div>
        </div>
    </div>
    ...
    <div class="addbox">
        ...
        <el-dialog v-model="dialogFormVisible" title="新增">
            <el-form :model="PayChannelForm" style="display: flex; flex-wrap: wrap">
                ...
                <el-input v-model="input" placeholder="请输入 appid" style="width: 380px; padding: 0 30px 20px 15px" />
                <div class="newadd">支付类型:</div>
                <el-input v-model="input" placeholder="请输入 支付类型" style="width: 380px; padding: 0 30px 20px 15px" />
                <div class="newadd">渠道名称:</div>
                <el-input v-model="input" placeholder="请输入 渠道名称" style="width: 380px; padding: 0 30px 20px 15px" />
                <div class="newadd">商户号:</div>
                <el-input v-model="input" placeholder="请输入 渠道商户号" style="width: 380px; padding: 0 30px 20px 15px" />
                <div class="newadd">渠道状态:</div>
                <el-select v-model="value1" placeholder="请输入 渠道状态" style="width: 380px; padding: 0 30px 20px 15px">
                    <el-option v-for="item in options1" :key="item.value1" :label="item.label1" :value="item.value1" />
                </el-select>
                <div class="newadd">备注:</div>
                <el-input v-model="input" placeholder="请输入 备注" style="width: 380px; padding: 0 30px 20px 15px" />

                <div class="newadd">配置参数:</div>
                <el-input v-model="input" placeholder="请输入 扩展参数.json字符串" style="width: 840px; padding: 0 30px 20px 15px" />
            </el-form>
        ...
        <div class="hintbox">
            <el-tooltip content="刷新" effect="dark" placement="top">
                <el-button v-loading.fullscreen.lock="fullscreenLoading" class="lod" type="primary" @click="openFullScreen1">
                    <div class="hint">
                        <img alt="" class="ico" src="../../../src/assets/icon/sx.png" />
                    </div>
                </el-button>
            </el-tooltip>
            ...
            <el-tooltip content="搜索" effect="dark" placement="top">
                <div class="hint" @click="showhide()">
                    <img alt="" class="ico" src="../../../src/assets/icon/sss.png" />
                </div>
            </el-tooltip>
        </div>
    </div>
