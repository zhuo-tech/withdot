...
import { ExamConfig } from '@/model/entity/Dot/DotConfig'
...
const value: ExamConfig = props.value as any
 ...
 * 表格 多选发生变化调用函数
 */
const handleSelectionChange = (selected: Array<CoreExam>) => value.exam = selected
getQuestionList(page)
</script>
