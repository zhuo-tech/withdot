...
import { filterTime, getSchedule } from '@/utils/utils'
import { ref } from 'vue'
    ...
    <div>
        ...
        <div>
            <el-dialog
                ...
                title="学员详情"
                width="70%"
                @closed="service.closedDialog">
                <el-row :gutter="10" style="margin-bottom: 20px">
                    <el-col v-if="service.detail.data.avatar" :span="5">
                ...
                <el-collapse v-model="service.activeName" accordion>
                    <el-collapse-item name="1" title="浏览记录">
                        <el-table
                            ...
                            <el-table-column label="完成时间" min-width="200">
                                <template #default="{row}">
                                    <span v-if="row.lastTime">{{ filterTime(row.lastTime) }}</span>
                                    <span v-else>/</span>
                                </template>
                            </el-table-column>
                        </el-table>
                    ...
                    <el-collapse-item v-if="service.detail.data.isPay === '0'" name="2" title="购买记录">
                        <el-table
